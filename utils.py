...
def Collaborative_filtering_recommender_system(Name,Nationality):
    df=pd.read_csv('DATA_RECOMMENDATION_UI.csv')
    df_name=df[df['Reviewer Name']==Name]
    df_name_nationality=df_name[df_name['Nationality']==Nationality]
    return df_name_nationality